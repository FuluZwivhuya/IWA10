...
console.log (holidays[christmas] ||` ID ${futureId} not created yet"`);// testing purpose
...
correctDate = copied.date.toLocaleDateString('en-GB');
...
const date = new Date();
const firstDate = firstHolidayTimestamp["date"];
console.log(firstHolidayTimestamp[date])
